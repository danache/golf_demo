...
from src.skeleton.CPN.lib.tfflat.base import ModelDesc, Trainer
from src.skeleton.CPN.lib.tfflat.utils import mem_info

from src.skeleton.CPN.lib.nets.basemodel import resnet101, resnet_arg_scope, resnet_v1
